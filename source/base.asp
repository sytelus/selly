...
<% 
	...
	'On coming to login page, force user to relogin
	Session("UserID") = ""
	Session("UserName") = ""
	Session("UserType") = ""
	...
	If Request.QueryString("reason") <> "" Then
			...
			sSQL = sSQL & "USER_ID = '" & Request("UserID") & "' AND PASSWORD = '" & Request("Password") & "'"
...
<!-- #INCLUDE FILE = "pageupperpart.inc" -->
	...
	<CENTER><FONT FACE="Arial" COLOR="Red">Please Login: </FONT>
			<FONT FACE="Arial" COLOR="Maroon">Before you can access secured pafes on this site you must do the System Login.</FONT><BR>
			<BR><BR>
	</CENTER>	
	<%
		End If
...
<!-- #INLCUDE FILE="pagelowerpart.inc" -->